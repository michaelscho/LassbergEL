...
def build_line_stream(
    ...
    *,
    ...
    total_lines = 0
    lb_break_next = False  # carry-over for break="no" due to trailing '¬' in transkribption
    ...
    for i, page_path in enumerate(pages, start=1):
        ...
        # Number lines continuously per page
...
def _page_sort_key(letter_id: str):
    """
    Prefer numeric sort by suffix '-<i>.xml'. Fallback to name.
    """
